        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
          ...
          >
            <div className="w-20 h-20 rounded-full bg-[#C8A14A]/10 flex items-center justify-center mx-auto mb-8">
              <BarChart3 className="text-[#C8A14A]" size={36} />
            </div>
            <h2 className="text-3xl lg:text-4xl font-serif text-[#0B1F3A] mb-6">
              Reports Coming Soon
            </h2>
            <p className="text-gray-500 text-lg leading-relaxed mb-10">
              Annual impact reports are currently being prepared. These reports will provide transparent data on leadership activities, transformation projects, and business impact across all portfolio companies.
            </p>
            ...
            <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-sm max-w-md mx-auto">
              ...
              <p className="text-gray-500 text-sm mb-6">
                Be the first to know when reports are published.
              </p>
              {subscribed ? (
                <div className="bg-[#C8A14A]/10 border border-[#C8A14A]/30 rounded-xl p-4 text-center">
                  <p className="text-[#0B1F3A] font-medium text-sm">Thank you! We'll notify you when reports are available.</p>
                </div>
              ) : (
        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-12 text-center">
          ...
          >
            ...
            <h2 className="text-3xl lg:text-4xl font-serif text-white mb-6">
              Learn About Christiana's Portfolio
            </h2>
            <p className="text-white/50 text-lg mb-8 max-w-2xl mx-auto">
              Explore the organizations and transformation projects that demonstrate measurable impact.
            </p>
