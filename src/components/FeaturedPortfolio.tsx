...
const portfolioCompanies = [
  {
    ...
    description: "As Group COO, Christiana oversees multi-business operations across logistics, manufacturing, and industrial services — driving operational excellence and strategic cohesion across 5+ business units.",
  ...
  },
  {
    ...
    sector: "Salt Production & Commodities",
    description: "Led a comprehensive scale-up of Ghana's leading salt producer — restructuring operations, driving a 300% capacity increase, and positioning Eagle Salt as a regional export leader.",
    impact: "300% production capacity increase; export market entry",
  ...
  },
  {
    ...
    description: "Providing strategic guidance for maritime logistics and shipping operations, including fleet optimization, route efficiency, and operational governance.",
  ...
  },
  {
    ...
    description: "Providing governance and strategic direction for industrial maintenance services — supporting market expansion across West Africa through sound advisory leadership.",
  ...
  },
  {
    ...
    description: "Led the strategic planning, governance framework, and cross-disciplinary execution of a premium mixed-use real estate development positioned for long-term value creation.",
    impact: "Premium development portfolio — long-term value creation",
  ...
  },
  {
    ...
    description: "Executed a full business turnaround — diagnosing root causes, restructuring management, optimizing pricing, and restoring profitability within 12 months.",
    impact: "Profitability restored within 12 months",
