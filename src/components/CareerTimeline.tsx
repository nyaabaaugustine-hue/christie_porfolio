...
const careerStages = [
  {
    ...
    period: "Early Career",
    description: "Built expertise in communications, branding, and strategic marketing.",
  },
  {
    phase: "Venture",
    title: "Entrepreneur",
    period: "Growth Phase",
    description: "Founded and scaled multiple ventures across diverse sectors.",
  },
  {
    phase: "Building",
    title: "Business Builder",
    period: "Expansion",
    description: "Developed operational capabilities and market presence.",
  },
  {
    phase: "Leadership",
    title: "Transformation Executive",
    period: "Executive Phase",
    description: "Led major organizational transformations and turnarounds.",
  },
  {
    phase: "Executive",
    title: "Group COO",
    period: "Current",
    description: "Overseeing multi-business operations and strategic growth.",
  },
  {
    phase: "Advisory",
    title: "Board & Advisory Leader",
    period: "Ongoing",
    description: "Serving on boards and providing strategic counsel to organizations.",
  },
];
      ...
      <div className="relative max-w-5xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-white/50 max-w-xl mx-auto">
            From creative foundations to executive leadership — a trajectory 
            defined by continuous learning and transformational impact.
          </p>
        </motion.div>
            ...
            {careerStages.map((stage, index) => (
              ...
              >
                <div className={`flex-1 pl-14 lg:pl-0 ${index % 2 === 0 ? "lg:text-right" : "lg:text-left"}`}>
                  ...
                  <p className={`leading-relaxed max-w-sm lg:max-w-none lg:inline-block ${stage.period === "Current" || stage.period === "Ongoing" ? 'text-white/70' : 'text-white/50'}`}>
                    {stage.description}
                  </p>
                </div>
